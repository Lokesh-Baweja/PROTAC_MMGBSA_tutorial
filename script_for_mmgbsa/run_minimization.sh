...
&cntrl
 ...
 restraintmask=":1-512&!@H=", ! atoms to be restrained (all in residue 1-253 but not H)
...
out=(POI-E3.en POILig.en E3Lig.en)
out_frames=(complex.per-frame.dat BRD4asLig.per-frame.dat CRBNasLig.per-frame.dat)
receptor_prmtop=(POI-E3.prmtop E3-protac.prmtop POI-protac.prmtop)
ligand_prmtop=(protac.prmtop POI.prmtop E3.prmtop)
